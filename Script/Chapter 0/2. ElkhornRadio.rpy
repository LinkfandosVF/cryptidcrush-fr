...
label atTheStation:
    ...
    Narrator "Arrivant dans le parking vide de la station, tu te gare à travers les lignes quasi éffacés. Taro sort et se jette dans tes bras, insistant pour être porté comme le bébé sur-dimensionné qu'elle est. Tu ouvre la porte et sort."
    ...
    Robyn "Oooké! Tout vas bien aller. C'est juste une station abandonnée. Rien de très flippant."
    ...
    Narrator  "Tu tourne plûtot ton attention vers un large morceau de bois accroché sur le grillage, sur lequel à sauvagement été écrit à la bombe de peinture en lettres rouges majuscules. Tu le lit a voix haute."
    ...
    Robyn "Dégagez! Les trépasseurs seront {sc=2}{b}{color=#EC2A2A}éxecutés!{/color}{/b}{/sc}."
    ...
    voice taro_laughc
    Taro "J'ai entendu que cet endroit s'illuminait en rouge les nuits de vendredi, et que le panneau ON AIR ne s'éteint jamais la nuit! Juste des petites rummeurs débiles si tu veux mon avis."
    ...
    Robyn "Il est déja 2 Heures du mat'! Ils sont censé être déja là!"

    Narrator "Tu regarde l'heure, avant de remettre ton téléphone portable dans ta poche puis scanne les environs avec ta lampe."
    ...
    Atlas "{b}DONC{/b},.,., C'est ça l'ésprit qui te hante? Huh. J'aurais espéré quelque chose de plus...{w=0.3} Impressionant."
    python:
        Taro_State["mouth"] = 1
        Taro_State["pawL"] = 1
    ...
    Robyn "Comment t'es arrive aussi vite?!"
    python:
        Atlas_State["eye"] = 7
    ...
    Narrator "Jamie prend la chaine qui retient les grillages, et se prépare à la séctionner en 2. Elle coupe le vérou et fait un petit pouce en l'air."
    python:
...
label exploreStation:
    ...
    Narrator "En regardant dans le couloir, l'interieur de l'endroit a l'air impossiblement propre par rapport à l'exterieur. La salle d'attente à l'air suspendu dans le temps, seulement salie par des mois de négligence... peut-être même des années."
    python:
        Atlas_State["eye"] = 1
    ...
    Atlas "En fait moi c'est avec mes antennes, avec ces bon vieux gros yeux, ma vision est super sensible à la lumière."
    ...
    Atlas "Okay, c'est plus sentir que voir en fait."
    ...
    Jamie "Pour une maison hanté pas vérouillée, c'est plûtot en bon état. Je me sens presque mal à l'idée de salir l'endroit."
    ...
    Robyn "Où est-ce que tu crois qu'on trouvera le type?"
    ...
    Atlas "Je vais te mettre à jour. En gros, la star du show c'était ce mec, Madhouse Mike, il lisait des histoires de cryptides et de légendes urbaines comme script. C'était super cool et j'ai vraiment aimé."
    camera:
    ...
    show atlas:
        yoffset 0
        matrixtransform RotateMatrix(0.0, 180.0, 0.0)
    Atlas "{sc=1}Il en à bu tellement que sa peau s'est mise a briller d'une couleur {color=#3bec27}vert fluo{/color}{/sc}! Il est mort sur l'instant de toute la radiation! \n\nLe studio a du fermer, et personne de vivant a été sur l'air depuis!"
    ...
    Jamie "Tu t'entends parler, serieux?"
    ...
    Atlas "Et risquer énerver le type a qu'on est sur le point d'emmerder en plein pendant son émition radio? Hors de question!"
    ...
    Robyn "Atlas, pense a tout le merch exclusif—! Tu pourras même demander un autographe."
    $Atlas_State["eye"] = 4
    $Atlas_State["feelers"] = 0

    Atlas "Tu crois? En fait, verifions la salle des enregistrements, doit y a voir des vinyls collector ou des cassettes exclusives quelque part."
    ...
    Narrator "Son expression s'assombris, son regard descent avant de se poser sur toi. Ta gorge se sèche alors que tu éssaie de sortir une réponse pas trop stupide."

    Robyn "Eh ben... Je connais Atlas depuis genre,, l'éternité! Il m'a juste aidé a déballer!"
    ...
    Jamie "Ils me surnomment le {bt=4}Maître du grill{/bt}."
    $Jamie_State["mouth"] = 0
    ...
    Robyn "Ca roule, {bt=4}Maître du grill!{/bt}"

    voice jamie_angry
    Jamie "Ne m'appele pas comme ça, s'il te plaît."
    ...
    Narrator  "Le mothman fouille dans les enregistrements tous écrasés, laissant tomber des fragments de ce qui était précedement entier ses mains."
    ...
    Atlas "{sc=3}Non!{/sc} Tout est dans les riche sons omni-dimensionel!"
...
label investigation_loop:
    ...
    menu:
        ...
        "Bulletins" if inv2:
            ...
            Narrator "Tu regrette imédiatement d'avoir demandé, mais décide de garder le coupon quand même... au cas où?"
        ...
        "Etagère a trophées" if inv5:
            ...
            Narrator "Tu regarde la déstruction, seulement pour trouver les restes d'Awards pour des gens comme Shark Infinity, Tiny Red Panda, et DJ Bean Angel. Rien sur Madhouse, par contre."
    ...
    if numInvest == 2:  #2 Things have been investigated
        ...
        Narrator "Atlas te montre son portable, affichant une masse verte floue qui porte une casquette et une veste, c'est un peu dûr a voir."
...
label endInvestigation:
    ...
    Jamie "Gras mots pour un homme mort."
    ...
    Madhouse "... T'es un incendie ambulant."
